...
private final MechanismLigament2d bigArmLigament2d = bigArmPivot.append(
  ...
  public void simulationPeriodic() {
    ...
    bigArm.setEncoder((int) Conversions.degreesToFalcon(Units.radiansToDegrees(bigArmSim.getAngleRads()), 80));
    ...
    lilArm.setEncoder((int)Conversions.degreesToFalcon(Units.radiansToDegrees(lilArmSim.getAngleRads()), 5));
